...
public interface BookstoreFacade {
	...
	void setCustomerService(CustomerDBService customerDBService);
	void setWarehouseService(WharehouseService wharehouseService);
	void setBookService(BookDBService bookDBService);
